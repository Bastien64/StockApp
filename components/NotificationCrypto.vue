        ...
        <div v-if="firstThreeItems.length > 0">
            ...
            <div v-for="firstThreeItem in firstThreeItems" :key="firstThreeItem.id" class="alert alert-danger">
                ...
                <div class="header">
                    ...
                    <p v-if="firstThreeItem.open > firstThreeItem.price"> Today : <img class="image" src="../public/icone/decrease.png" alt=""></p>
...
export default {
    ...
    mounted() {
        this.updateMyDate();
        fetch('https://financialmodelingprep.com/api/v3/quote/BTCUSD,ETHUSD,POTUSD?apikey=9fb2c7e0767d325798293dbd93d429f3')
            .then(response => response.json())
            .then(data => {
                this.firstThreeItems = data.slice(0.3);
            })
            .catch(error => {
